...
modelspec(1).cvfunc = @(t1,t2,dt1t2,thetas,ad,fp1fp2)  cvfunc.G(dt1t2,thetas(1:2)) + cvfunc.L(dt1t2,ad,thetas(8:10)) + cvfunc.W(dt1t2,ad,thetas(11)) + cvfunc.RN(t1,t2,dt1t2,ad,thetas(5:7)) + cvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)); 
     
modelspec(1).dcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) dcvfunc.G(t1,t2,dt1t2,thetas(1:2)) + dcvfunc.L(t1,t2,dt1t2,ad,thetas(8:10)) + dcvfunc.RN(t1,t2,dt1t2,ad,thetas(5:7)) + dcvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4));    

modelspec(1).ddcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) ddcvfunc.G(dt1t2,thetas(1:2)) + ddcvfunc.L(dt1t2,ad,thetas(8:10)) + ddcvfunc.RN(dt1t2,ad,thetas(5:7)) + ddcvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)); 

modelspec(1).traincv = @(t1,t2,dt1t2,thetas,errcv,ad,fp1fp2) modelspec(1).cvfunc(t1,t2,dt1t2,thetas,ad,fp1fp2) + errcv;

tluTGG = [
 
    500 1 80000    % 1 Matern global amplitude 
    100 1 80000  % 2 Temporal parameter
 
    1 0.01 40000      %  3 Linear amplitude
    2 0.5 12         %  4 Geographic length scale

    100 0.01 40000    % 5 Matern regional amplitude
    100 1 40000   % 6 Temporal parameter
    2 0.5 12         % 7 Geographic length scale
    
    100 0.01 40000    % 8 Matern local amplitude
    100 1 40000     % 9 Temporal parameters
    0.01 0.001 2     % 10 Geographic length scale
