...
base_thet0 = [3000 3000 500 1000 0.25 100]; % starting point
base_lb    = [ 1000  1000   10 300 0.000005  0.1]; % lower bound
% base_lb    = [ 1000  1000   10 300 0.00005  0.1]; % lower bound
% base_ub    = [100000 10000  8000 2000 0.60  5000]; % upper bound
base_ub    = [100000 20000  8000 2000 0.60  5000]; % upper bound
