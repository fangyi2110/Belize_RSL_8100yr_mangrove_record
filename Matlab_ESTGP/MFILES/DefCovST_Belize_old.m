...
base_thet0 = [1000 1000 1000 1000 0.3 500 10 0.01 100]; % starting point
base_lb    = [100 50 100 50 0.05 10 1 0.005 0.1]; % lower bound
base_ub    = [100000 10000 100000 10000 1 50000 10000 0.1 1e6]; % upper bound
