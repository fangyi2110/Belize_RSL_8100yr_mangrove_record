...
modelspec(1).cvfunc = @(t1,t2,dt1t2,thetas,ad,fp1fp2)  cvfunc.G(dt1t2,thetas(1:2)) + cvfunc.L(dt1t2,ad,thetas(8:10)) + cvfunc.W(dt1t2,ad,thetas(11)) ...
     + cvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)) + cvfunc.RN(t1,t2,dt1t2,ad,thetas(5:7)); 
...
tluTGG = [
    ...
    500 1 22000    % 1 Matern global amplitude 
    100 1 22000  % 2 Temporal parameter
 
    1 0.01 22000      % 3 Linear amplitude
    1 0.05 12         % 4 Geographic length scale

    100 0.01 22000    % 5 Matern regional amplitude
    100 1 22000   % 6 Temporal parameter
    2 0.05 12          % 7 Geographic length scale
    
    100 0.01 22000    % 8 Matern local amplitude
    100 1 22000     % 9 Temporal parameters
