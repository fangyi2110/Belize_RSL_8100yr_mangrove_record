...
modelspec(1).cvfunc = @(t1,t2,dt1t2,thetas,ad,fp1fp2)  cvfunc.G(dt1t2,thetas(1:2)) + cvfunc.L(dt1t2,ad,thetas(8:10)) + cvfunc.W(dt1t2,ad,thetas(11)) ...
   % + cvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)) 
     + cvfunc.RN(t1,t2,dt1t2,ad,thetas(5:7)); 

modelspec(1).dcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) dcvfunc.G(t1,t2,dt1t2,thetas(1:2)) + dcvfunc.L(t1,t2,dt1t2,ad,thetas(8:10)) ...
  % + dcvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)) 
    + dcvfunc.RN(t1,t2,dt1t2,ad,thetas(5:7));

modelspec(1).ddcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) ddcvfunc.G(dt1t2,thetas(1:2)) + ddcvfunc.L(dt1t2,ad,thetas(8:10)) ...
  % + ddcvfunc.RL(t1,t2,dt1t2,ad,thetas(3:4)) 
    + ddcvfunc.RN(dt1t2,ad,thetas(5:7));
...
tluTGG = [
 ...
 %   1 0.01 30000      %  Linear amplitude
 %   1 0.01 12         %  Geographic length scale

    100 0.01 30000    % 3 Matern regional amplitude
    100 1 30000   % 4 Temporal parameter
    2 0.05 12         % 5 Geographic length scale
    
    100 0.01 30000    % 6 Matern local amplitude
    100 1 30000     % 7 Temporal parameters
    0.01 0.001 5     % 8 Geographic length scale
 
    100 0.1 10e5    % 9 white noise
         ];
