function [fslopeavg,sdslopeavg,fslopeavgdiff,sdslopeavgdiff,diffplus,diffless,Vslopeavg,Vslopeavgdiff]=SLRateCalc(wf,wV,testsites,testreg,testts,firstyears,lastyears)
...
for kk=1:size(testsites,1)
    ...
    if dodiff
        ...
        %diffplus = [2 3 ... length(firstyears)]
        %diffless = [length(firstyears) ... length(firstyears)]
