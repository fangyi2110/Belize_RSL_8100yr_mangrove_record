function [sl_rate, testnames] = makeplot_slrate(dataset,f2s_shifted,sd2s,V2s,testloc,labl,doplots,difftimestep,xlim0,xrange,meanSL,plot_dat,GIAtime,GIAsite,GIArsl6G,GIArsl7G,yl)
